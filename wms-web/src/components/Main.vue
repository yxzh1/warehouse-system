...
export default {
  ...
  data(){
    ...
    let checkDuplicate = (rule,value,callback)=>{
      ...
      this.$axios.get(this.$httpsUrl+"/user/findByNo?no="+this.form.no).then(res=>res.data).then(res=>{
        if(res.code!=200){
          callback()
        }else {
  ...
  methods:{
    ...
    del(id){
      this.$axios.get(this.$httpsUrl+'/user/del?id='+id).then(res=>res.data).then(res=>{
        if(res.code==200){
          this.$message({
            message: '操作成功',
            type: 'success'
    ...
    doSave(){
      this.$axios.post(this.$httpsUrl+'/user/save',this.form).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code==200){
          this.$message({
            message: '操作成功',
    ...
    doMod(){
      this.$axios.post(this.$httpsUrl+'/user/update',this.form).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code==200){
          this.$message({
            message: '操作成功',
    ...
    loadGet(){
      this.$axios.get(this.$httpsUrl+'/user/1').then(res=>res.data).then(res=>{
        console.log(res)
        this.tableData=res
      })
    },
